          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                <p className="text-base font-semibold leading-7 text-indigo-600">Discover books</p>
              ...
              <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                ...
                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                  <li className="flex gap-x-3">
                    ...
                    <span>
                      <strong className="font-semibold text-gray-900">Easy Navigation.</strong> CLick through the website find all the books you wish to
                    </span>
                  </li>
                  <li className="flex gap-x-3">
                    <HiLockClosed className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                    <span>
                      <strong className="font-semibold text-gray-900">Secure Transactions.</strong> Added features of safe banking transactions for the book.
                    </span>
                  </li>
                  <li className="flex gap-x-3">
